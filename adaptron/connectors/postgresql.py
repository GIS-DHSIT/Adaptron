"""PostgreSQL connector using SQLAlchemy for schema discovery and data fetching."""
...
class PostgreSQLConnector(BaseConnector):
    """Connector for PostgreSQL databases via SQLAlchemy."""
    ...
    def _build_conn_str(config: ConnectorConfig) -> str:
        """Construct postgresql://user:pass@host:port/db from individual fields."""
