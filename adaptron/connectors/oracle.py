"""Oracle connector using SQLAlchemy for schema discovery and data fetching."""
...
@register_plugin("connector", "oracle")
class OracleConnector(BaseConnector):
    """Connector for Oracle databases via SQLAlchemy."""
    ...
    def _build_conn_str(config: ConnectorConfig) -> str:
        """Construct oracle+oracledb://user:pass@host:port/db from individual fields."""
        ...
        return f"oracle+oracledb://{auth}{host}:{port}/{database}"
        ...
        with self._engine.connect() as conn:
            ...
            for row in result:
                ...
                doc = RawDocument(
                    ...
                    source_ref=f"oracle://{query.collection}",
                )
