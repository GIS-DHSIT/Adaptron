"""SQLite connector using SQLAlchemy for schema discovery and data fetching."""
...
@register_plugin("connector", "sqlite")
class SQLiteConnector(BaseConnector):
    """Connector for SQLite databases via SQLAlchemy."""
    ...
    def _build_conn_str(config: ConnectorConfig) -> str:
        """Construct sqlite:///path/to/db from individual fields."""
        ...
        with self._engine.connect() as conn:
            ...
            for row in result:
                ...
                doc = RawDocument(
                    ...
                    source_ref=f"sqlite://{query.collection}",
                )
