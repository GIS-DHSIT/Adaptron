"""MySQL connector using SQLAlchemy for schema discovery and data fetching."""
...
@register_plugin("connector", "mysql")
class MySQLConnector(BaseConnector):
    """Connector for MySQL databases via SQLAlchemy."""
    ...
    def _build_conn_str(config: ConnectorConfig) -> str:
        """Construct mysql+pymysql://user:pass@host:port/db from individual fields."""
        ...
        with self._engine.connect() as conn:
            ...
            for row in result:
                ...
                doc = RawDocument(
                    ...
                    source_ref=f"mysql://{query.collection}",
                )
