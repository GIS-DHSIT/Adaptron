...
@register_plugin("trainer", "cpt")
class CPTTrainer(BaseTrainer):
    """Continued Pre-Training trainer for raw domain corpus.

    Dataset items should have a "text" key containing the raw text
    ...
    async def train(
        ...
        bus.emit(
            ...
            Event(
                type="train_start",
                data={"mode": "cpt", "base_model": config.base_model},
            ),
        )
        ...
        try:
            ...
            raise ImportError(
                "Continued pre-training requires 'transformers' and 'datasets'. "
        ...
        bus.emit(
            ...
            Event(
                type="train_complete",
                data={"mode": "cpt", "loss": train_result.training_loss},
            ),
        )
